...
export const Sidebar = memo(function Sidebar({ activeTab, setActiveTab }: SidebarProps) {
  ...
  const menuItems: MenuItem[] = [
    ...
    { id: "modesetup", icon: Sliders, label: "Mode Setup", requiredPermission: "system_settings" },
    { id: "calibration", icon: Wrench, label: "Calibration", requiredPermission: "system_settings" },
    { id: "mavtools", icon: Radio, label: "MAVLink Tools", requiredPermission: "system_settings" },
    { id: "rtk", icon: Satellite, label: "RTK / NTRIP", requiredPermission: "system_settings" },
    { id: "vehiclesetup", icon: Car, label: "Vehicle Setup", requiredPermission: "system_settings" },
    { id: "swarm", icon: Users2, label: "Swarm Ops", requiredPermission: "system_settings" },
    { id: "plugins", icon: Puzzle, label: "Plugins", requiredPermission: "system_settings" },
    { id: "mp-parity", icon: ListChecks, label: "MP Parity", requiredPermission: "system_settings" },
