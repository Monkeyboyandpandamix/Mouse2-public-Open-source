...
cat > "$OUTPUT_DIR/$DIST_NAME/package.json" << 'EOF'
{
  "name": "mouse-gcs",
  "version": "1.0.0",
  "description": "M.O.U.S.E. Ground Control Station - Multi-purpose Operational Unmanned Aerial System for Emergency Response",
  "type": "module",
  "license": "MIT",
  "scripts": {
